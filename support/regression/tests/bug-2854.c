...
#if !defined( __SDCC_pdk14) && !defined( __SDCC_pdk15) && !((defined(__SDCC_mcs51) || defined(__SDCC_mcs251)) && (defined(__SDCC_MODEL_SMALL) || defined(__SDCC_MODEL_MEDIUM))) // Lack of memory
