...
_hasNativeMulFor (iCode *ic, sym_link *left, sym_link *right)
{
  ...
  /* Native 16x16->32 unsigned multiply (MUL WRj,WRk -> DRj).  The MCS251
     allocator keeps this result out of R8-R15 because the backend handler
     uses those registers as fixed scratch/output registers. */
